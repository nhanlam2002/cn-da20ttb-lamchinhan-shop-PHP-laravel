            ...
            <ul class="sequence-canvas">
                <li class="animate-in">
                    ...
                    <div class="flat-caption caption3 formLeft delay500 text-center">
                        <p>Chào mừng đến với cửa hàng nội thất của chúng tôi - nơi cung cấp các sản phẩm đa dạng và chất lượng cao. Đến với chúng tôi để tìm kiếm phong cách của bạn!</p>
                        <p>Phong cách của bạn là niềm đam mê của chúng tôi - Hãy để chúng tôi giúp bạn thiết kế nó</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="products">
                            ...
                            <div class="button_group"><a href="javascript:void(0)" class="button add-cart" type="button">Xem Chi Tiết</a></div>
                        </div>
                    </div>
                    @endforeach
                </div>
